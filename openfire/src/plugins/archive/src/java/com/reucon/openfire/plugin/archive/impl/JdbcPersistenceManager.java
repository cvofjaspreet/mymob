...
public class JdbcPersistenceManager implements PersistenceManager
{
    ...
    private static Logger Log = Logger.getLogger(JdbcPersistenceManager.class);
    ...
    public static final String SELECT_MESSAGE_TIME =
            "SELECT time FROM archiveMessages WHERE subject = ?";
    ...
    public boolean createMessage(ArchivedMessage message)
    {
        ...
        {
            Log.info("Error saving archived message", sqle);
            return false;
        }
        finally
        {
    ...
    public List<Conversation> findConversations(Date startDate, Date endDate, String ownerJid, String withJid, XmppResultSet xmppResultSet)
    {
       ...
       if (startDate != null)
        ...
        //comment to get all users chat
        if (withJid != null)
        {
            appendWhere(whereSB, CONVERSATION_WITH_JID, " LIKE ?");
        }
    ...
    public Conversation getConversationForGroup(Long conversationId, String ownerJid, String withJid, Date start)
    {
    	Log.info("getConversationForGroup");
        ...
        else
        {
            ...
            {
                querySB.append(" AND ");
                querySB.append(CONVERSATION_WITH_JID).append(" Like ?");
            }
            if (start != null)
            {
                querySB.append(" AND ");
    ...
    @Override
    public String getMessageTime(String messageid) {
		Connection con = null;
		PreparedStatement pstmt = null;
		ResultSet rs = null;
		...
		try {
			con = DbConnectionManager.getConnection();
			pstmt = con.prepareStatement(SELECT_MESSAGE_TIME);
	...
	@Override
	public Conversation getConversationForGroup(String ownerJid,
